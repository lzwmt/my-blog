...
export const siteProfile: SiteProfile = {
  ...
  heroDescription:
    "这个前台保留了 Digital Architect 原型中最强的视觉骨架，并去掉社区化机制，让阅读体验重新回到中心。"
};
...
export const sitePosts: SitePost[] = [
  {
    ...
    contentHtml: `
      ...
      <p>这个 MVP 的设计目标不是功能堆满，而是建立信任感。访客应该在几秒内读懂站点的语气，再自然进入阅读流程。</p>
      <h2>先把编辑性布局做好</h2>
  ...
  },
  {
    ...
    contentHtml: `
      <p>每个编辑器都会带来一种诱惑：支持更多块级元素、更多嵌入能力、更多布局例外。MVP 应该克制住这种冲动。</p>
